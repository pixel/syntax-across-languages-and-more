...
'Various' => [
  ...
  [ { MLANG => "C Tcl ClassicREXX Logo MUMPS Prolog Maple" },
   'until end of line' =>
   [
    '///' => "C# Java",
    '-- |' => "Haskell",
...
<br>[^0-9[](){}":;/][^ \n\t[](){}":;/]*) => "Rebol",
  ...
  [
   'assignment' =>
   [
    '=' => "B C C++ C# Io Java Perl Perl6 Matlab Pike PHP Basic Erlang Icon Oz JavaScript Lua BourneShell Awk YCP ClassicREXX Yorick",
  ...
  [ { MLANG => 'EmacsLisp CommonLisp Scheme XSLT PostScript Forth' },
   '( ... )' => "Beta BCPL Io Logo Prolog B ClassicREXX Maple C C++ C# Matlab YCP Java Eiffel Rebol MUMPS MSH Pike Perl Perl6 Python Ruby Pascal Haskell OCaml Smalltalk SML merd E Tcl PHP JavaScript Lua Ada Awk Modula-3 Pliant XPath Oz SQL92 Yorick",
   '[ ... ]' => "Rebol",
   'indentation' => "merd",
   '$ ...' => "Haskell",
  ...
  [ { ALL => 1 },
   '' =>
   [
    '< > <= >=' => "Ada Awk Io Beta Maple Logo B C C++ C# YCP E Matlab Java Pascal Rebol Smalltalk VisualBasic Scheme Pike Perl Perl6 merd Tcl Haskell Ruby SML OCaml PHP Eiffel JavaScript EmacsLisp CommonLisp Dylan Lua Awk Modula-3 Python Pliant XPath ClassicREXX SQL92 Yorick",
    '< > =< >=' => "Mercury Oz",
    "< > '> '<" => "MUMPS",
...
'Functions' => [
  ...
  [ { KIND => 'functional', ALL => 1, MLANG => "Smalltalk Io Maple CommonLisp Scheme Erlang Matlab" },
...
for i=1:nargin
 ...(varargin{i})
  ...
  [ { MLANG => 'Prolog PostScript' },
   ...
   [
    'no syntax needed (in Matlab, only for anonymous function)' => "Maple Io Haskell OCaml Erlang SML EmacsLisp Tcl Rebol CommonLisp Scheme Perl Perl6 Ruby Dylan Oz Matlab",
   ],
...
'Booleans' => [
 ...
 [
  'short circuit' =>
  [
   '|| / &&' => "Awk C C++ C# Java Matlab Pike Perl Perl6 YCP Ruby OCaml Haskell merd Tcl E PHP JavaScript Yorick",
   '| / &' => "B BCPL Dylan",
...
'Mathematics' => [
 ...
 [ { ALL => 1 },
   'integers' =>
   [
    '1000' => 'Awk Ada Io C++ B Maple Prolog Logo Rebol C C# Haskell E Java JavaScript Pascal Pliant Pike Python BourneShell Tcl Scheme Smalltalk Perl Perl6 Ruby Eiffel OCaml merd Oz SQL92 Yorick',
 ...
 [ { MLANG => 'Pascal' },
  ...
  '^' => 'Eiffel Awk Dylan Lua Matlab Pliant Yorick',
 ...
 'negation' =>
 [
  '-' => "B Io BCPL Awk Maple Logo C++ C C# E Java Matlab Rebol Pike MUMPS Pliant Haskell Python BourneShell Tcl Scheme Smalltalk Perl Perl6 Ruby Eiffel merd EmacsLisp CommonLisp JavaScript Ada Prolog ClassicREXX Yorick",
  '- -.' => "OCaml",
  '~' => "SML Oz",
  'neg' => "PostScript",
  'negate' => "Rebol",
...
ran.Next(...);') => "C#",
 ...
 [ { MLANG => 'Scheme CommonLisp EmacsLisp' },
  ...
  [
   'mathematical' => "C C++ Maple Io Java C# Eiffel Perl Perl6 Python Ruby BourneShell merd Matlab Tcl Haskell ClassicREXX Yorick",
   'same priorities' => "Smalltalk MUMPS",
  ],

  'exponentiation vs negation (is -3^2 equal to 9 or -9)' =>
  [ { MLANG => 'C C++ MUMPS' },
   'mathematical' => "Perl Perl6 Maple Io Eiffel Ruby Python Haskell Matlab ClassicREXX",
